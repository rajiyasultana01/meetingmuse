...
export default function AdminMeetingDetail() {
  ...
  const fetchMeetingData = async () => {
    try {
      setIsLoading(true);
      // Admin also uses generic endpoint which now supports admin access if role is admin
      ...
      <Layout>
        <div className="p-8 max-w-6xl mx-auto">
          <Card className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">{error || 'This meeting does not exist.'}</p>
            <Button onClick={() => navigate("/admin/meetings")} className="rounded-xl">
      ...
      <div className="p-8 max-w-6xl mx-auto">
        ...
        <div className="mb-6">
          ...
          {meeting.videoUrl && meeting.status === 'completed' && (
            <Button
              onClick={() => navigate(`/admin/meetings/${id}/play`)}
        ...
        {meeting.status === 'completed' && summary && transcript && (
          <MeetingReport
            summary={summary.summaryText || summary.summary_text}
